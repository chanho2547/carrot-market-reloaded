  ...
  return (
    <main className="bg-gray-900  h-screen flex items-center justify-center p-5">
      <div className="bg-white w-full max-w-screen-sm shadow-lg p-5 rounded-3xl flex flex-col md:flex-row gap-2">
        ...
        <button className="bg-black text-white py-2 rounded-full active:scale-90 transition-transform font-medium  outline-none md:px-10 peer-invalid:bg-red-100 peer-required:bg-green-500">
          Login
        </button>
      </div>
    </main>
